%% [MOD OF] SUpDEq - Spatial Upsampling by Directional Equalization
%
...
function [samplingGridParL, samplingGridParR] = hrtf_parallax(samplingGrid, sourceDistance, head_radius, earPosition)

if nargin < 4 || isempty(earPosition)
    earPosition = [90, 0, 270, 0];
end
...
[x_ear_L,y_ear_L,z_ear_L] = sph2cart(earPosition_L(:,1),earPosition_L(:,2),...
                                                              head_radius); 
[x_ear_R,y_ear_R,z_ear_R] = sph2cart(earPosition_R(:,1),earPosition_R(:,2),...
                                                              head_radius);  
